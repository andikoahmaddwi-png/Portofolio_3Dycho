          ...
          <div className="relative min-h-screen flex items-center justify-center px-4">
            <div className="w-full max-w-5xl mx-auto text-center z-20">
              ...
              <div className="text-center mb-8 sm:mb-10 md:mb-12">
                <h1 className="text-5xl sm:text-6xl md:text-8xl font-extrabold space-y-2 sm:space-y-4">
              ...
              <div className="text-center" data-aos="fade-up" data-aos-delay="1200">
                <a
                  href="https://www.dycho.my.id"
                  className="inline-flex items-center gap-4 px-8 py-4 sm:px-10 sm:py-5 rounded-full relative group hover:scale-105 transition-transform duration-300"
                  target="_blank"
                ...
                >
                  ...
                  <div className="relative flex items-center gap-4 text-2xl sm:text-3xl md:text-4xl">
                    <Globe className="w-6 h-6 sm:w-7 sm:h-7 text-purple-400" />
                    <span className="bg-gradient-to-r from-purple-400 via-purple-500 to-purple-600 bg-clip-text text-transparent font-extrabold">
                      <TypewriterEffect text="www.dycho.my.id" />
                    </span>
                  </div>
                </a>
              </div>
